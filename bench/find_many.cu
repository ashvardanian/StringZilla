/**
 *  @file scripts/bench_find_many.cu
 ...
 *      --expt-relaxed-constexpr bench/find_many.cu -o find_many_cu
 *  STRINGWARS_DATASET=haystack_64mib.txt STRINGWARS_TOKENS=file ./find_many_cu
 *  @endcode
 *
 ...
 *  This file is a sibling of `bench_find_many.cpp` and of `bench_similarities.cu`.
 */
...
int main(int argc, char const **argv) {
    ...
    std::printf("Welcome to the StringZillas find-many benchmark on GPU!\n");
