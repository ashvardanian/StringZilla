...
STRINGZILLA_DISPATCH_INTERNAL void sz_dispatch_substrings_gpu_update_(void) {
    ...
    impl->substrings_counts = STRINGZILLA_NULL;
    impl->substrings_find = STRINGZILLA_NULL;
    impl->substrings_replace = STRINGZILLA_NULL;
    impl->substrings_bm25_scores = STRINGZILLA_NULL;
