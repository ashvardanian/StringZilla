...
STRINGZILLA_DISPATCH_INTERNAL void sz_dispatch_overlap_gpu_update_(void) {
    ...
    else sz_dispatch_gpu_table.overlap_scores = (sz_overlap_scores_t)STRINGZILLA_NULL;
#else
    sz_dispatch_gpu_table.overlap_scores = (sz_overlap_scores_t)STRINGZILLA_NULL;
#endif
}
