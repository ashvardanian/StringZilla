/**
 *  @file c/stringzillas/find_many_serial.cpp
 ...
 *  one `find_many` needs.
 */
#include "stringzillas/find_many.hpp" // Dictionary + engine
...
template struct find_many<u16_t, std::allocator<char>, sz_caps_sp_k>;
template struct aho_corasick_dictionary<u32_t, std::allocator<char>>;
template struct find_many<u32_t, std::allocator<char>, sz_caps_sp_k>;
