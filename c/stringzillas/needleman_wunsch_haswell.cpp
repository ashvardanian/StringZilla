/**
 *  @file c/stringzillas/needleman_wunsch_haswell.cpp
 *  @brief Haswell (AVX2) single-pair scorer instantiations for parallel Needleman-Wunsch global alignment.
...
template status_t //
needleman_wunsch_score<char, error_costs_32x32_t, linear_gap_costs_t,
                       sz_caps_sh_k>::operator()<fu::basic_pool_t>( //
