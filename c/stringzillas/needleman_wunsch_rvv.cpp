/**
 *  @file c/stringzillas/needleman_wunsch_rvv.cpp
 *  @brief RVV (RISC-V) single-pair scorer instantiations for parallel Needleman-Wunsch global alignment.
