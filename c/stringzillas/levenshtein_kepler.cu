...
template __global__ void score_per_cuda_warp_<                                                   //
    ...
    uniform_substitution_costs_t, sz_minimize_distance_k, sz_similarity_global_k, sz_caps_ck_k>( //
...
template __global__ void score_across_cuda_device_<                                            //
    ...
    sz_minimize_distance_k, sz_similarity_global_k, sz_caps_ck_k, cuda_similarity_task<char>>( //
