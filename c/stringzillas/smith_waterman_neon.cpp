/**
 *  @file c/stringzillas/smith_waterman_neon.cpp
 *  @brief NEON (AArch64) single-pair scorer instantiations for parallel Smith-Waterman local alignment.
...
template status_t //
smith_waterman_score<char, error_costs_32x32_t, linear_gap_costs_t,
                     sz_caps_sn_k>::operator()<fu::basic_pool_t>( //
