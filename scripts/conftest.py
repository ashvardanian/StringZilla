...
(test_string.py, test_find.py, test_utf8_words.py, …) inherits them without importing anything. The
...
from test_helpers import SEED_VALUES, _random_seed_for_run, numpy_available, pyarrow_available
