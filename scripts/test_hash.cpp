...
static void check_sha256_unit_(                                  //
    ...
    sz_sha256_state_digest_t digest, char const *message, char const *expected_hex) {
    sz_sha256_state_t state;
    sz_u8_t produced[32], expected[32];
    sha256_digest_from_hex_(expected_hex, expected);
    init(&state);
    update(&state, message, (sz_size_t)std::strlen(message));
...
void test_hash_unit() {
    ...
    assert(sz_bytesum("abc", 3) == 0x126u);        // Dispatched (automatic kernel)
    ...
    assert(sz_hash(fox, fox_length, 0u) == sz_hash(fox, fox_length, 0u));             // Deterministic
...
struct fill_random_from_sz_ {
    void operator()(sz_ptr_t text, sz_size_t length, sz_u64_t nonce) const noexcept {
        generate_(text, length, nonce);
    }
};
 ...
 *  @param inputs     Unused count placeholder; kept for a uniform differential signature.
 */
template <typename reference_, typename candidate_>
...
void test_hash_all() {
    ...
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_westmere> {}, 200);
#endif
#if SZ_USE_SKYLAKE
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_skylake> {}, 200);
#endif
#if SZ_USE_ICELAKE
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_icelake> {}, 200);
#endif
#if SZ_USE_NEONAES
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_neonaes> {}, 200);
#endif
#if SZ_USE_SVE2AES
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_sve2aes> {}, 200);
#endif
#if SZ_USE_V128
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_v128> {}, 200);
#endif
    ...
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_v128relaxed> {}, 200);
#endif
#if SZ_USE_RVV
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_rvv> {}, 200);
#endif
#if SZ_USE_LASX
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_lasx> {}, 200);
#endif
#if SZ_USE_POWERVSX
    test_hash_equivalence(hash_serial,
                          ...
                          200);
    test_random_equivalence(fill_random_from_sz_<sz_fill_random_serial> {},
                            fill_random_from_sz_<sz_fill_random_powervsx> {}, 200);
#endif
    ...
    test_sha256_equivalence(
        sha256_serial,
        sha256_from_sz_<sz_sha256_state_init_icelake, sz_sha256_state_update_icelake, sz_sha256_state_digest_icelake> {},
        256);
#endif
#if SZ_USE_GOLDMONT
    ...
    test_sha256_equivalence(
        sha256_serial,
        sha256_from_sz_<sz_sha256_state_init_v128, sz_sha256_state_update_v128, sz_sha256_state_digest_v128> {}, 256);
#endif
#if SZ_USE_RVV
    test_sha256_equivalence(
        sha256_serial,
        sha256_from_sz_<sz_sha256_state_init_rvv, sz_sha256_state_update_rvv, sz_sha256_state_digest_rvv> {}, 256);
#endif
#if SZ_USE_LASX
    test_sha256_equivalence(
        sha256_serial,
        sha256_from_sz_<sz_sha256_state_init_lasx, sz_sha256_state_update_lasx, sz_sha256_state_digest_lasx> {}, 256);
#endif
#if SZ_USE_POWERVSX
    test_sha256_equivalence(sha256_serial,
