...
#
# One module carries one SIMD tier. `-msimd128` defines `__wasm_simd128__`, so `SZ_USE_V128` auto-detects to 1 in
...
set(SZ_TARGET_FLAGS "--target=wasm32-wasip1 --sysroot=${SZ_SYSROOT} -msimd128")
...
if(SZ_WASM_RUNTIME STREQUAL "wasmer")
    ...
    set(CMAKE_CROSSCOMPILING_EMULATOR "${SZ_WASMER};run;--dir;${CMAKE_CURRENT_LIST_DIR}/..")
else()
    find_program(SZ_WASMTIME wasmtime PATHS "$ENV{HOME}/.wasmtime/bin")
    set(CMAKE_CROSSCOMPILING_EMULATOR
        "${SZ_WASMTIME};-W;relaxed-simd=y;-W;exceptions=y;--dir;${CMAKE_CURRENT_LIST_DIR}/..")
endif()
