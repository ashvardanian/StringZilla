 ...
 *  @date August 8, 2026
 *  @brief AVX2 (Haswell) backend for multi-pattern search: root skips through the
 *      AVX2 byte-set search.
 *
...
STRINGZILLA_API_COMPTIME sz_size_t sz_substrings_count_bytes_haswell(sz_substrings_engine_t const *engine,
...
STRINGZILLA_API_COMPTIME void sz_substrings_find_bytes_haswell(sz_substrings_engine_t const *engine, sz_cptr_t haystack,
...
/** The Haswell stages. */
STRINGZILLA_API_COMPTIME sz_substrings_walks_t sz_substrings_walks_haswell_(void) {
