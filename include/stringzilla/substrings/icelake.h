...
STRINGZILLA_API_COMPTIME sz_size_t sz_substrings_count_bytes_icelake(sz_substrings_engine_t const *engine,
...
STRINGZILLA_API_COMPTIME void sz_substrings_find_bytes_icelake(sz_substrings_engine_t const *engine, sz_cptr_t haystack,
...
/** The Ice Lake stages. */
STRINGZILLA_API_COMPTIME sz_substrings_walks_t sz_substrings_walks_icelake_(void) {
