...
SZ_INTERNAL __m256i sz_utf8_next1_lasx_(__m256i window) {
    ...
    __m256i const cross_lane_carry_u8x32 = __lasx_xvbsll_v(high_half_duplicated_u8x32, 15); // high-half byte 0 → lane 15
...
SZ_INTERNAL sz_size_t sz_utf8_pack_indices_lasx_(sz_u32_t mask, sz_u8_t *out) {
    ...
    for (int half = 0; half < 4; ++half) {
        ...
        __m256i const packed_indices_u8x32 =
            __lasx_xvshuf_b(byte_identity_iota_u8x32, byte_identity_iota_u8x32, shuffle_lookup_row_u8x32);
...
SZ_INTERNAL sz_size_t sz_utf8_rune_drain_lasx_( //
    ...
    for (sz_size_t block_start = 0; block_start < want; block_start += 4) {
        ...
        __m256i const two_byte_codepoint_u32x8 =
            __lasx_xvor_v(__lasx_xvslli_w(__lasx_xvand_v(lead_u32x8, mask_word_1f_u32x8), 6),
        ...
        decoded_codepoint_u32x8 =
            __lasx_xvbitsel_v(decoded_codepoint_u32x8, replacement_codepoint_u32x8, ill_formed_mask_vec.lasx);
...
SZ_INTERNAL sz_cptr_t sz_utf8_decode_once_lasx_( //
    ...
    if (high_bits == 0) {
        ...
        for (; group + 4 <= runes_to_unpack; group += 4) {
            __m256i const widened_ascii_u32x8 =
                __lasx_xvsllwil_wu_hu(__lasx_xvsllwil_hu_bu(__lasx_xvld(staging_vec.u8s + group, 0), 0), 0);
    ...
    __m256i const sequence_length_u8x32 =
        __lasx_xvshuf_b(length_lookup_table_u8x32, length_lookup_table_u8x32, high_nibble_u8x32);
    ...
    __m256i const global_lane_offset_u8x32 =
        __lasx_xvadd_b(__lasx_xvld(lane_identity_raw, 0), __lasx_xvld(lane_high_bias, 0));
    ...
    sz_u32_t const past_end =
        sz_xvmovemask_b_utf8_lasx_(__lasx_xvslt_bu(__lasx_xvreplgr2vr_b((char)chunk), sequence_end_offset_u8x32)) &
        starts_bits;
    ...
    sz_u32_t const len2 =
        sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(sequence_length_u8x32, __lasx_xvreplgr2vr_b(2))) & starts_bits;
    sz_u32_t const len3 =
        sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(sequence_length_u8x32, __lasx_xvreplgr2vr_b(3))) & starts_bits;
    sz_u32_t const len4 =
        sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(sequence_length_u8x32, __lasx_xvreplgr2vr_b(4))) & starts_bits;
    ...
    sz_u32_t const lead_lt_c2 =
        sz_xvmovemask_b_utf8_lasx_(__lasx_xvslt_bu(window_u8x32, __lasx_xvreplgr2vr_b((char)0xC2)));
    sz_u32_t const lead_gt_f4 =
        sz_xvmovemask_b_utf8_lasx_(__lasx_xvslt_bu(__lasx_xvreplgr2vr_b((char)0xF4), window_u8x32));
    ...
    if (has_three || has_four) {
        ...
        sz_u32_t const is_e0 =
            sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(window_u8x32, __lasx_xvreplgr2vr_b((char)0xE0)));
        sz_u32_t const is_ed =
            sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(window_u8x32, __lasx_xvreplgr2vr_b((char)0xED)));
        sz_u32_t const is_f0 =
            sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(window_u8x32, __lasx_xvreplgr2vr_b((char)0xF0)));
        sz_u32_t const is_f4 =
            sz_xvmovemask_b_utf8_lasx_(__lasx_xvseq_b(window_u8x32, __lasx_xvreplgr2vr_b((char)0xF4)));
        sz_u32_t const n1_lt_a0 =
            sz_xvmovemask_b_utf8_lasx_(__lasx_xvslt_bu(next_byte_u8x32, __lasx_xvreplgr2vr_b((char)0xA0)));
        sz_u32_t const n1_ge_a0 = (~n1_lt_a0) & loaded_mask;
        sz_u32_t const n1_lt_90 =
            sz_xvmovemask_b_utf8_lasx_(__lasx_xvslt_bu(next_byte_u8x32, __lasx_xvreplgr2vr_b((char)0x90)));
    ...
    __m256i const one_byte_u8x32 = __lasx_xvreplgr2vr_b(1);
    {
        ...
        maximal_subpart_length_u8x32 =
            __lasx_xvadd_b(maximal_subpart_length_u8x32, __lasx_xvand_v(step_byte_mask_vec.lasx, one_byte_u8x32));
    ...
    sz_size_t const produced =
        sz_utf8_rune_drain_lasx_(window_u8x32, emit_starts, ill_formed, maximal_subpart_length_u8x32, has_three,
...
SZ_PUBLIC sz_size_t sz_utf8_count_lasx(sz_cptr_t text, sz_size_t length) {
    ...
    while (length >= 32) {
        ...
        __m256i is_continuation_u8x32 = __lasx_xvseq_b(header_mask_u8x32, continuation_pattern_u8x32); /* 0xFF where cont */
