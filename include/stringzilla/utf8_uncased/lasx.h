...
SZ_PUBLIC sz_cptr_t sz_utf8_uncased_search_lasx(   //
...
SZ_PUBLIC sz_cptr_t sz_utf8_find_cased_lasx(sz_cptr_t str, sz_size_t length) {
    return sz_utf8_find_cased_serial(str, length);
}

SZ_PUBLIC sz_ordering_t sz_utf8_uncased_order_lasx(sz_cptr_t a, sz_size_t a_length, sz_cptr_t b, sz_size_t b_length) {
