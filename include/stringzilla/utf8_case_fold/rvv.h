...
SZ_INTERNAL vuint8m8_t sz_utf8_fold_ascii_rvv_(vuint8m8_t source_u8m8, sz_size_t vl) {
...
SZ_INTERNAL sz_size_t sz_utf8_fold_latin_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    sz_size_t vl = __riscv_vsetvl_e8m8(remaining);
    ...
    vbool1_t is_irregular = __riscv_vmsne_vx_u8m8_b1(__riscv_vand_vx_u8m8(delta, 0x80, vl), 0, vl);
    ...
    folded = __riscv_vmerge_vvm_u8m8(folded, __riscv_vadd_vx_u8m8(folded, 0x20, vl), is_latin1_upper, vl);
    ...
    folded = __riscv_vmerge_vxm_u8m8(
        folded, 0xCE,
        __riscv_vmand_mm_b1(__riscv_vmseq_vx_u8m8_b1(source, 0xC2, vl), __riscv_vmseq_vx_u8m8_b1(next, 0xB5, vl), vl),
        vl);
    folded = __riscv_vmerge_vxm_u8m8(folded, 0xBC,
                                     __riscv_vmand_mm_b1(after_c2, __riscv_vmseq_vx_u8m8_b1(source, 0xB5, vl), vl), vl);
    ...
    vbool1_t is_non_ascii = __riscv_vmsgtu_vx_u8m8_b1(source, 0x7F, vl);
    vbool1_t is_lead = __riscv_vmandn_mm_b1(is_non_ascii, is_continuation, vl);
    vbool1_t is_family_lead = __riscv_vmsleu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(source, 0xC2, vl), 4, vl);
    vbool1_t is_foreign_lead = __riscv_vmandn_mm_b1(is_lead, is_family_lead, vl);
    vbool1_t stop = __riscv_vmor_mm_b1(is_foreign_lead, is_irregular, vl);

    long first_stop = __riscv_vfirst_m_b1(stop, vl);
    sz_size_t consumed;
    if (first_stop >= 0) {
...
SZ_INTERNAL sz_size_t sz_utf8_fold_cyrillic_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    vbool1_t is_d1 = __riscv_vmseq_vx_u8m8_b1(source, 0xD1, vl);
    vbool1_t after_d0 = __riscv_vmseq_vx_u8m8_b1(previous, 0xD0, vl);
    vbool1_t is_lead = __riscv_vmandn_mm_b1(__riscv_vmsgtu_vx_u8m8_b1(source, 0x7F, vl), is_continuation, vl);
    vbool1_t is_foreign_lead = __riscv_vmandn_mm_b1(is_lead, __riscv_vmor_mm_b1(is_d0, is_d1, vl), vl);
    // Cyrillic Extended-A (D1 A0+) folds by parity across blocks — leave it to serial.
    vbool1_t is_extended = __riscv_vmand_mm_b1(is_d1, __riscv_vmsgeu_vx_u8m8_b1(next, 0xA0, vl), vl);
    vbool1_t stop = __riscv_vmor_mm_b1(is_foreign_lead, is_extended, vl);
...
SZ_INTERNAL sz_size_t sz_utf8_fold_greek_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    vbool1_t is_continuation = __riscv_vmseq_vx_u8m8_b1(__riscv_vand_vx_u8m8(source, 0xC0, vl), 0x80, vl);
    vbool1_t is_ce = __riscv_vmseq_vx_u8m8_b1(source, 0xCE, vl);
    vbool1_t is_cf = __riscv_vmseq_vx_u8m8_b1(source, 0xCF, vl);
    vbool1_t after_ce = __riscv_vmseq_vx_u8m8_b1(previous, 0xCE, vl);
    vbool1_t after_cf = __riscv_vmseq_vx_u8m8_b1(previous, 0xCF, vl);
    vbool1_t is_lead = __riscv_vmandn_mm_b1(__riscv_vmsgtu_vx_u8m8_b1(source, 0x7F, vl), is_continuation, vl);
    vbool1_t is_foreign_lead = __riscv_vmandn_mm_b1(is_lead, __riscv_vmor_mm_b1(is_ce, is_cf, vl), vl);
    ...
    vbool1_t ce_excluded = __riscv_vmand_mm_b1(
        is_ce,
        __riscv_vmor_mm_b1(__riscv_vmsltu_vx_u8m8_b1(next, 0x91, vl), __riscv_vmseq_vx_u8m8_b1(next, 0xB0, vl), vl),
        vl);
    vbool1_t cf_excluded = __riscv_vmand_mm_b1(is_cf, __riscv_vmsgeu_vx_u8m8_b1(next, 0x8F, vl), vl);
    vbool1_t stop = __riscv_vmor_mm_b1(is_foreign_lead, __riscv_vmor_mm_b1(ce_excluded, cf_excluded, vl), vl);

    // Promoting ranges (second byte A0-A1 or A3-AB), used both for the second-byte -0x20 and the lead +1.
    vbool1_t in_promote_a0 = __riscv_vmsltu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(source, 0xA0, vl), 0x02, vl);
    vbool1_t in_promote_a3 = __riscv_vmsltu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(source, 0xA3, vl), 0x09, vl);
    vbool1_t next_promote_a0 = __riscv_vmsltu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(next, 0xA0, vl), 0x02, vl);
    vbool1_t next_promote_a3 = __riscv_vmsltu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(next, 0xA3, vl), 0x09, vl);

    vbool1_t is_upper = __riscv_vmsleu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(source, 'A', vl), 25, vl);
    vuint8m8_t folded = __riscv_vmerge_vvm_u8m8(source, __riscv_vadd_vx_u8m8(source, 0x20, vl), is_upper, vl);
    vbool1_t basic_upper = __riscv_vmand_mm_b1(
        after_ce, __riscv_vmsltu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(source, 0x91, vl), 0x0F, vl), vl);
    folded = __riscv_vadd_vx_u8m8_mu(basic_upper, folded, folded, 0x20, vl);
    vbool1_t promoting_upper = __riscv_vmand_mm_b1(after_ce, __riscv_vmor_mm_b1(in_promote_a0, in_promote_a3, vl), vl);
    folded = __riscv_vadd_vx_u8m8_mu(promoting_upper, folded, folded, 0xE0, vl); // -0x20
    ...
    vbool1_t promotes_lead = __riscv_vmand_mm_b1(is_ce, __riscv_vmor_mm_b1(next_promote_a0, next_promote_a3, vl), vl);
    folded = __riscv_vadd_vx_u8m8_mu(promotes_lead, folded, folded, 0x01, vl); // CE -> CF
...
SZ_INTERNAL sz_size_t sz_utf8_fold_armenian_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    vbool1_t is_d6 = __riscv_vmseq_vx_u8m8_b1(source, 0xD6, vl);
    vbool1_t after_d4 = __riscv_vmseq_vx_u8m8_b1(previous, 0xD4, vl);
    vbool1_t after_d5 = __riscv_vmseq_vx_u8m8_b1(previous, 0xD5, vl);
    vbool1_t is_lead = __riscv_vmandn_mm_b1(__riscv_vmsgtu_vx_u8m8_b1(source, 0x7F, vl), is_continuation, vl);
    vbool1_t is_family = __riscv_vmor_mm_b1(__riscv_vmor_mm_b1(is_d4, is_d5, vl), is_d6, vl);
    vbool1_t is_foreign_lead = __riscv_vmandn_mm_b1(is_lead, is_family, vl);
    vbool1_t d4_stop = __riscv_vmand_mm_b1(is_d4, __riscv_vmsltu_vx_u8m8_b1(next, 0xB1, vl), vl);
    vbool1_t ligature_stop = __riscv_vmand_mm_b1(is_d6, __riscv_vmseq_vx_u8m8_b1(next, 0x87, vl), vl);
    vbool1_t stop = __riscv_vmor_mm_b1(is_foreign_lead, __riscv_vmor_mm_b1(d4_stop, ligature_stop, vl), vl);
...
SZ_INTERNAL sz_size_t sz_utf8_fold_georgian_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    vuint8m8_t next = __riscv_vslide1down_vx_u8m8(source, carry1, vl);
    vuint8m8_t next_next = __riscv_vslide1down_vx_u8m8(next, carry2, vl);

    vbool1_t is_continuation = __riscv_vmseq_vx_u8m8_b1(__riscv_vand_vx_u8m8(source, 0xC0, vl), 0x80, vl);
    vbool1_t is_e1 = __riscv_vmseq_vx_u8m8_b1(source, 0xE1, vl);
    vbool1_t is_lead = __riscv_vmandn_mm_b1(__riscv_vmsgtu_vx_u8m8_b1(source, 0x7F, vl), is_continuation, vl);
    vbool1_t is_foreign_lead = __riscv_vmandn_mm_b1(is_lead, is_e1, vl);
    vbool1_t is_82_lead = __riscv_vmand_mm_b1(is_e1, __riscv_vmseq_vx_u8m8_b1(next, 0x82, vl), vl);
    vbool1_t is_83_lead = __riscv_vmand_mm_b1(is_e1, __riscv_vmseq_vx_u8m8_b1(next, 0x83, vl), vl);
    vbool1_t is_foreign_e1 = __riscv_vmandn_mm_b1(is_e1, __riscv_vmor_mm_b1(is_82_lead, is_83_lead, vl), vl);
    vbool1_t stop = __riscv_vmor_mm_b1(is_foreign_lead, is_foreign_e1, vl);

    // Uppercase keyed by the third byte: E1 82 third >= A0; E1 83 third in 80-85, or 87, or 8D.
    vbool1_t is_82_upper_lead = __riscv_vmand_mm_b1(is_82_lead, __riscv_vmsgeu_vx_u8m8_b1(next_next, 0xA0, vl), vl);
    vbool1_t third_83_range = __riscv_vmsltu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(next_next, 0x80, vl), 0x06, vl);
    vbool1_t third_83_extra = __riscv_vmor_mm_b1(__riscv_vmseq_vx_u8m8_b1(next_next, 0x87, vl),
                                                 __riscv_vmseq_vx_u8m8_b1(next_next, 0x8D, vl), vl);
    vbool1_t is_83_upper_lead = __riscv_vmand_mm_b1(is_83_lead, __riscv_vmor_mm_b1(third_83_range, third_83_extra, vl),
                                                    vl);

    // Carry the per-block uppercase flag forward as a 0/1 byte: lane +1 (second) and lane +2 (third).
    vuint8m8_t flag82_lead = __riscv_vmerge_vxm_u8m8(__riscv_vmv_v_x_u8m8(0, vl), 1, is_82_upper_lead, vl);
    vuint8m8_t flag83_lead = __riscv_vmerge_vxm_u8m8(__riscv_vmv_v_x_u8m8(0, vl), 1, is_83_upper_lead, vl);
    vuint8m8_t flag82_second = __riscv_vslide1up_vx_u8m8(flag82_lead, 0, vl);
    vuint8m8_t flag83_second = __riscv_vslide1up_vx_u8m8(flag83_lead, 0, vl);
    vuint8m8_t flag82_third = __riscv_vslide1up_vx_u8m8(flag82_second, 0, vl);
    vuint8m8_t flag83_third = __riscv_vslide1up_vx_u8m8(flag83_second, 0, vl);

    vbool1_t is_upper_lead = __riscv_vmor_mm_b1(is_82_upper_lead, is_83_upper_lead, vl);
    vbool1_t is_upper_second = __riscv_vmsne_vx_u8m8_b1(__riscv_vor_vv_u8m8(flag82_second, flag83_second, vl), 0, vl);
    vbool1_t is_82_upper_third = __riscv_vmsne_vx_u8m8_b1(flag82_third, 0, vl);
    vbool1_t is_83_upper_third = __riscv_vmsne_vx_u8m8_b1(flag83_third, 0, vl);

    vbool1_t is_upper = __riscv_vmsleu_vx_u8m8_b1(__riscv_vsub_vx_u8m8(source, 'A', vl), 25, vl);
    vuint8m8_t folded = __riscv_vmerge_vvm_u8m8(source, __riscv_vadd_vx_u8m8(source, 0x20, vl), is_upper, vl);
    folded = __riscv_vmerge_vxm_u8m8(folded, 0xE2, is_upper_lead, vl);             // lead E1 -> E2
    folded = __riscv_vmerge_vxm_u8m8(folded, 0xB4, is_upper_second, vl);           // second 82/83 -> B4
    folded = __riscv_vadd_vx_u8m8_mu(is_82_upper_third, folded, folded, 0xE0, vl); // third -0x20
    folded = __riscv_vadd_vx_u8m8_mu(is_83_upper_third, folded, folded, 0x20, vl); // third +0x20
...
SZ_PUBLIC sz_size_t sz_utf8_case_fold_rvv(sz_cptr_t source, sz_size_t source_length, sz_ptr_t destination) {
    ...
    while (source_ptr < source_end) {
        ...
        while (ascii_bytes) {
            sz_size_t vl = __riscv_vsetvl_e8m8(ascii_bytes);
