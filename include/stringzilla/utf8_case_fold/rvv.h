...
SZ_INTERNAL sz_size_t sz_utf8_fold_greek_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    folded = __riscv_vadd_vx_u8m4_mu(basic_upper, folded, folded, 0x20, vl);
    vbool2_t promoting_upper = __riscv_vmand_mm_b2(after_ce, __riscv_vmor_mm_b2(in_promote_a0, in_promote_a3, vl), vl);
    folded = __riscv_vadd_vx_u8m4_mu(promoting_upper, folded, folded, 0xE0, vl); // -0x20
    ...
    folded = __riscv_vadd_vx_u8m4_mu(promotes_lead, folded, folded, 0x01, vl); // CE -> CF
...
SZ_INTERNAL sz_size_t sz_utf8_fold_georgian_strip_rvv_(sz_u8_t const *source_ptr, sz_size_t remaining,
    ...
    folded = __riscv_vadd_vx_u8m4_mu(is_82_upper_third, folded, folded, 0xE0, vl); // third -0x20
    folded = __riscv_vadd_vx_u8m4_mu(is_83_upper_third, folded, folded, 0x20, vl); // third +0x20
