...
SZ_INTERNAL sz_u64_t sz_hash_state_finalize_rvv_(sz_hash_state_t const *state) {
    ...
    sz_u128_vec_t aes0 = sz_emulate_aesenc_rvv_(aes_vecs[0], ins_vecs[0]);
    sz_u128_vec_t aes1 = sz_emulate_aesenc_rvv_(aes_vecs[1], ins_vecs[1]);
    sz_u128_vec_t aes2 = sz_emulate_aesenc_rvv_(aes_vecs[2], ins_vecs[2]);
    sz_u128_vec_t aes3 = sz_emulate_aesenc_rvv_(aes_vecs[3], ins_vecs[3]);
