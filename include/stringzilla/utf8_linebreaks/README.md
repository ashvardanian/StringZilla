...
This directory holds the kernels behind `sz_utf8_linebreaks`, which walks a UTF-8 string and yields each line-break opportunity as defined by the Unicode UAX-14 rules, marking the positions where a text layout engine is allowed to wrap rather than splitting on raw spaces or hard newlines alone.
