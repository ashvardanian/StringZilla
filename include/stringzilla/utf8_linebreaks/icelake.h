...
SZ_HELPER_AUTO __m512i sz_line_break_classify_astral16_icelake_(__m512i codepoints_u32x16) {
    ...
    __m512i const leaf_u32x16 = sz_utf8_rune_lut_cascade_icelake_(
        sz_utf8_line_break_astral_s2_, (int)sz_utf8_line_break_astral_s2_tiles_k, leaf_index_u32x16);
...
SZ_HELPER_INLINE void sz_line_break_descriptor_unpack_half_icelake_(__m512i descriptors_u16x32,
    ...
    classes_u16x32 = _mm512_mask_mov_epi16(classes_u16x32, is_sa_m32, _mm512_set1_epi16(sz_line_break_al_k));
    classes_u16x32 = _mm512_mask_mov_epi16(classes_u16x32, is_sa_m32 & sa_is_mark_m32,
                                           _mm512_set1_epi16(sz_line_break_cm_k));
    __mmask32 const is_alias_m32 = _mm512_cmpeq_epi16_mask(classes_u16x32, _mm512_set1_epi16(sz_line_break_ai_k)) |
                                   _mm512_cmpeq_epi16_mask(classes_u16x32, _mm512_set1_epi16(sz_line_break_sg_k)) |
                                   _mm512_cmpeq_epi16_mask(classes_u16x32, _mm512_set1_epi16(sz_line_break_xx_k));
    classes_u16x32 = _mm512_mask_mov_epi16(classes_u16x32, is_alias_m32, _mm512_set1_epi16(sz_line_break_al_k));
    __mmask32 const is_cj_m32 = _mm512_cmpeq_epi16_mask(classes_u16x32, _mm512_set1_epi16(sz_line_break_cj_k));
    classes_u16x32 = _mm512_mask_mov_epi16(classes_u16x32, is_cj_m32, _mm512_set1_epi16(sz_line_break_ns_k));

    __m512i side_u16x32 = _mm512_setzero_si512();
    side_u16x32 = _mm512_or_si512(
        side_u16x32, _mm512_maskz_mov_epi16(_mm512_test_epi16_mask(descriptors_u16x32, _mm512_set1_epi16(1 << 6)),
                                            _mm512_set1_epi16(sz_line_break_side_pi_k)));
    side_u16x32 = _mm512_or_si512(
        side_u16x32, _mm512_maskz_mov_epi16(_mm512_test_epi16_mask(descriptors_u16x32, _mm512_set1_epi16(1 << 7)),
                                            _mm512_set1_epi16(sz_line_break_side_pf_k)));
    side_u16x32 = _mm512_or_si512(
        side_u16x32, _mm512_maskz_mov_epi16(_mm512_test_epi16_mask(descriptors_u16x32, _mm512_set1_epi16(1 << 8)),
                                            _mm512_set1_epi16(sz_line_break_side_eaw_k)));
    side_u16x32 = _mm512_or_si512(
        side_u16x32, _mm512_maskz_mov_epi16(_mm512_test_epi16_mask(descriptors_u16x32, _mm512_set1_epi16(1 << 9)),
                                            _mm512_set1_epi16(sz_line_break_side_cn_k | sz_line_break_side_ext_k)));
    __m512i const raw_class_u16x32 = _mm512_and_si512(descriptors_u16x32, _mm512_set1_epi16(0x3F));
    side_u16x32 = _mm512_or_si512(
        side_u16x32,
        _mm512_maskz_mov_epi16(_mm512_cmpeq_epi16_mask(raw_class_u16x32, _mm512_set1_epi16(sz_line_break_ri_k)),
                               _mm512_set1_epi16(sz_line_break_side_ri_k)));
    side_u16x32 = _mm512_or_si512(
        side_u16x32,
        _mm512_maskz_mov_epi16(_mm512_cmpeq_epi16_mask(raw_class_u16x32, _mm512_set1_epi16(sz_line_break_zwj_k)),
                               _mm512_set1_epi16(sz_line_break_side_zwj_k)));
    __mmask32 const class_is_mark_m32 = _mm512_cmpeq_epi16_mask(classes_u16x32, _mm512_set1_epi16(sz_line_break_cm_k)) |
                                        _mm512_cmpeq_epi16_mask(classes_u16x32, _mm512_set1_epi16(sz_line_break_zwj_k));
    side_u16x32 = _mm512_or_si512(
...
SZ_HELPER_AUTO void sz_line_break_flat_palette_unpack_icelake_(__m512i palette_indices_u8x64,
    ...
    __mmask32 dotted_low_m32, dotted_high_m32;
...
SZ_HELPER_AUTO sz_line_break_classified_t sz_line_break_classify_window_icelake_(sz_utf8_rune_window_t window,
    ...
    sz_u64_t const lead_e0 = _cvtmask64_u64(_mm512_cmpeq_epi8_mask(raw_u8x64, _mm512_set1_epi8((char)0xE0)));
    sz_u64_t const lead_ed = _cvtmask64_u64(_mm512_cmpeq_epi8_mask(raw_u8x64, _mm512_set1_epi8((char)0xED)));
    sz_u64_t const lead_f0 = _cvtmask64_u64(_mm512_cmpeq_epi8_mask(raw_u8x64, _mm512_set1_epi8((char)0xF0)));
    sz_u64_t const lead_f4_or_above = _cvtmask64_u64(
        _mm512_cmp_epu8_mask(raw_u8x64, _mm512_set1_epi8((char)0xF4), _MM_CMPINT_NLT));
    ...
    if (!danger_leads) {
        ...
        sz_u64_t const lead_not_overlong2 = _cvtmask64_u64(_mm512_test_epi8_mask(raw_u8x64, _mm512_set1_epi8(0x1E)));
        sz_u64_t const b0_e0 = lead_e0;
        sz_u64_t const b0_ed = lead_ed;
        sz_u64_t const b0_f0 = lead_f0;
        sz_u64_t const b0_f4 = _cvtmask64_u64(_mm512_cmpeq_epi8_mask(raw_u8x64, _mm512_set1_epi8((char)0xF4)));
        sz_u64_t const b0_above_f4 = _cvtmask64_u64(
            _mm512_cmp_epu8_mask(raw_u8x64, _mm512_set1_epi8((char)0xF4), _MM_CMPINT_NLE));
        sz_u64_t const b1_lt_a0 = _cvtmask64_u64(_mm512_cmplt_epu8_mask(next1_u8x64, _mm512_set1_epi8((char)0xA0)));
        sz_u64_t const b1_ge_a0 = _cvtmask64_u64(
            _mm512_cmp_epu8_mask(next1_u8x64, _mm512_set1_epi8((char)0xA0), _MM_CMPINT_NLT));
        sz_u64_t const b1_lt_90 = _cvtmask64_u64(_mm512_cmplt_epu8_mask(next1_u8x64, _mm512_set1_epi8((char)0x90)));
        sz_u64_t const b1_ge_90 = _cvtmask64_u64(
            _mm512_cmp_epu8_mask(next1_u8x64, _mm512_set1_epi8((char)0x90), _MM_CMPINT_NLT));
    ...
    sz_u64_t const true_ascii = _cvtmask64_u64(_mm512_cmplt_epu8_mask(raw_u8x64, _mm512_set1_epi8((char)0x80))) &
    ...
    __m512i const next3_u8x64 = _mm512_permutexvar_epi8(_mm512_add_epi8(lane_identity_u8x64, _mm512_set1_epi8(3)),
                                                        raw_u8x64);
    __m512i const low_four_u8x64 = _mm512_or_si512(
        _mm512_and_si512(_mm512_slli_epi16(_mm512_and_si512(next2_u8x64, _mm512_set1_epi8(0x03)), 6),
                         _mm512_set1_epi8((char)0xC0)),
        _mm512_and_si512(next3_u8x64, _mm512_set1_epi8(0x3F)));
    __m512i const high_four_u8x64 = _mm512_or_si512(
    ...
    __m512i const plane_all_u8x64 = _mm512_or_si512(
        _mm512_and_si512(_mm512_slli_epi16(_mm512_and_si512(raw_u8x64, _mm512_set1_epi8(0x07)), 2),
                         _mm512_set1_epi8(0x1C)),
    ...
    if (is_astral) {
        ...
        __m512i astral_index_u8x64 = _mm512_setzero_si512();
        __m512i high_u32x16, low_u32x16, plane_u32x16, codepoints_u32x16, group_index_u32x16;
        high_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(high_fixed_u8x64, 0));
        low_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(low_fixed_u8x64, 0));
        plane_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(previous_cluster_lane_u8x64, 0));
        codepoints_u32x16 = _mm512_or_si512(
            _mm512_or_si512(_mm512_slli_epi32(plane_u32x16, 16), _mm512_slli_epi32(high_u32x16, 8)), low_u32x16);
        group_index_u32x16 = sz_line_break_classify_astral16_icelake_(codepoints_u32x16);
        astral_index_u8x64 = _mm512_inserti32x4(astral_index_u8x64, _mm512_cvtepi32_epi8(group_index_u32x16), 0);
        high_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(high_fixed_u8x64, 1));
        low_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(low_fixed_u8x64, 1));
        plane_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(previous_cluster_lane_u8x64, 1));
        codepoints_u32x16 = _mm512_or_si512(
            _mm512_or_si512(_mm512_slli_epi32(plane_u32x16, 16), _mm512_slli_epi32(high_u32x16, 8)), low_u32x16);
        group_index_u32x16 = sz_line_break_classify_astral16_icelake_(codepoints_u32x16);
        astral_index_u8x64 = _mm512_inserti32x4(astral_index_u8x64, _mm512_cvtepi32_epi8(group_index_u32x16), 1);
        high_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(high_fixed_u8x64, 2));
        low_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(low_fixed_u8x64, 2));
        plane_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(previous_cluster_lane_u8x64, 2));
        codepoints_u32x16 = _mm512_or_si512(
            _mm512_or_si512(_mm512_slli_epi32(plane_u32x16, 16), _mm512_slli_epi32(high_u32x16, 8)), low_u32x16);
        group_index_u32x16 = sz_line_break_classify_astral16_icelake_(codepoints_u32x16);
        astral_index_u8x64 = _mm512_inserti32x4(astral_index_u8x64, _mm512_cvtepi32_epi8(group_index_u32x16), 2);
        high_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(high_fixed_u8x64, 3));
        low_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(low_fixed_u8x64, 3));
        plane_u32x16 = _mm512_cvtepu8_epi32(_mm512_extracti32x4_epi32(previous_cluster_lane_u8x64, 3));
        codepoints_u32x16 = _mm512_or_si512(
            _mm512_or_si512(_mm512_slli_epi32(plane_u32x16, 16), _mm512_slli_epi32(high_u32x16, 8)), low_u32x16);
        group_index_u32x16 = sz_line_break_classify_astral16_icelake_(codepoints_u32x16);
        ...
        side_u8x64 = _mm512_mask_permutexvar_epi8(side_u8x64, astral_m64, astral_index_u8x64,
        ...
        __m512i const astral_dotted_bytes_u8x64 = _mm512_permutexvar_epi8(
            astral_index_u8x64, _mm512_load_si512((void const *)sz_utf8_line_break_palette_dotted_));
...
#pragma GCC unroll 64
    ...
    frame.side_cn = sz_line_break_side_mask_icelake_(side_u8x64, sz_line_break_side_cn_k);
    frame.side_ext = sz_line_break_side_mask_icelake_(side_u8x64, sz_line_break_side_ext_k);
    _mm512_storeu_si512((void *)effective_class_byte_out, classes_u8x64);
    _mm512_storeu_si512((void *)side_byte_out, side_u8x64);
    return frame;
}
...
SZ_API_COMPTIME sz_size_t sz_utf8_linebreaks_icelake_bytes_( //
    ...
    while (position < length) {
        ...
        sz_line_break_classified_t const classified = sz_line_break_classify_window_icelake_(window,
                                                                                             lane_identity_u8x64);
