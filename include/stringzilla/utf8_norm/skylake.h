...
SZ_PUBLIC sz_cptr_t sz_utf8_norm_violation_skylake(sz_cptr_t source, sz_size_t length, sz_normal_form_t form) {
    return sz_utf8_norm_violation_engine_(source, length, form, &sz_utf8_norm_classify_skylake_);
}
