 ...
 */
SZ_INTERNAL __m256i sz_utf8_ci_haswell_in_byte_range_(__m256i values_ymm, sz_u8_t range_start, sz_u8_t range_length) {
 ...
 */
SZ_INTERNAL __m256i sz_utf8_ci_haswell_previous_bytes_(__m256i source_ymm) {
 ...
 */
SZ_INTERNAL __m256i sz_utf8_ci_haswell_next_bytes_(__m256i source_ymm) {
...
SZ_INTERNAL sz_u32_t sz_utf8_ci_haswell_mask_until_(sz_size_t n) {
 ...
 */
SZ_INTERNAL __m256i sz_utf8_ci_haswell_load_padded_ymm_(sz_cptr_t source, sz_size_t length) {
    sz_u8_t buffer[32] = {0};
 ...
 */
SZ_INTERNAL __m128i sz_utf8_ci_haswell_load_window_xmm_(sz_cptr_t source, sz_size_t available) {
 ...
 */
SZ_INTERNAL __m256i sz_utf8_case_insensitive_find_haswell_ascii_fold_ymm_(__m256i text_ymm) {
    // Only fold bytes in range A-Z; the masked add avoids `VPBLENDVB` (2 uops on Haswell)
    __m256i is_ascii_upper_ymm = sz_utf8_ci_haswell_in_byte_range_(text_ymm, 'A', 26);
 ...
 */
SZ_INTERNAL sz_cptr_t sz_utf8_case_insensitive_find_haswell_ascii_3probe_( //
    ...
    while (haystack_ptr < haystack_end) {
        ...
        __m256i text_ymm = available >= 32 ? _mm256_lddqu_si256((__m256i const *)haystack_ptr)
                                           : sz_utf8_ci_haswell_load_padded_ymm_(haystack_ptr, chunk_size);
        __m256i folded_ymm = sz_utf8_case_insensitive_find_haswell_ascii_fold_ymm_(text_ymm);
        ...
        matches &= sz_utf8_ci_haswell_mask_until_(valid_starts);
...
typedef __m256i (*sz_utf8_case_insensitive_fold_ymm_t_)(__m256i text_ymm);
 ...
 */
typedef sz_u32_t (*sz_utf8_case_insensitive_alarm_ymm_t_)(__m256i text_ymm, sz_u32_t load_mask);
 ...
 */
SZ_FORCE_INLINE sz_cptr_t sz_utf8_case_insensitive_find_haswell_scripted_( //
    sz_utf8_case_insensitive_fold_ymm_t_ fold,                             //
    sz_utf8_case_insensitive_alarm_ymm_t_ alarm,                           //
    sz_cptr_t haystack, sz_size_t haystack_length,                         //
    sz_cptr_t needle, sz_size_t needle_length,                             //
    sz_utf8_case_insensitive_needle_metadata_t const *needle_metadata,     //
    sz_size_t *matched_length) {
    ...
    sz_u32_t const folded_window_mask = sz_utf8_ci_haswell_mask_until_(folded_window_length);
    ...
    while (haystack_ptr < haystack_end) {
        ...
        sz_u32_t const load_mask = sz_utf8_ci_haswell_mask_until_(chunk_size);
        sz_u32_t const valid_mask = sz_utf8_ci_haswell_mask_until_(valid_starts);
        ...
        for (; matches; matches &= matches - 1) {
            ...
            __m128i window_xmm = sz_utf8_ci_haswell_load_window_xmm_(
 ...
 */
SZ_INTERNAL sz_cptr_t sz_utf8_case_insensitive_find_haswell_ascii_4probe_( //
    sz_cptr_t haystack, sz_size_t haystack_length,                         //
    sz_cptr_t needle, sz_size_t needle_length,                             //
    sz_utf8_case_insensitive_needle_metadata_t const *needle_metadata,     //
    sz_size_t *matched_length) {
    return sz_utf8_case_insensitive_find_haswell_scripted_( //
        ...
        (sz_utf8_case_insensitive_alarm_ymm_t_)SZ_NULL, //
 ...
 */
SZ_INTERNAL __m256i sz_utf8_case_insensitive_find_haswell_western_europe_fold_ymm_(__m256i text_ymm) {
    ...
    __m256i is_eszett_ymm = _mm256_or_si256(is_eszett_second_ymm, sz_utf8_ci_haswell_next_bytes_(is_eszett_second_ymm));
 ...
 */
SZ_INTERNAL sz_u32_t sz_utf8_case_insensitive_find_haswell_western_europe_alarm_ymm_(__m256i text_ymm,
                                                                                     sz_u32_t load_mask) {
    ...
    if (is_e1_ba_danger_mask) {
        sz_u32_t is_expanding_third_mask = (sz_u32_t)_mm256_movemask_epi8(
            sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x96, 0x09));
 ...
 *  @sa sz_utf8_case_rune_safe_western_europe_k
 */
SZ_INTERNAL sz_cptr_t sz_utf8_case_insensitive_find_haswell_western_europe_( //
    sz_cptr_t haystack, sz_size_t haystack_length,                           //
    sz_cptr_t needle, sz_size_t needle_length,                               //
    sz_utf8_case_insensitive_needle_metadata_t const *needle_metadata,       //
    sz_size_t *matched_length) {
    return sz_utf8_case_insensitive_find_haswell_scripted_( //
        sz_utf8_case_insensitive_find_haswell_western_europe_fold_ymm_,
        sz_utf8_case_insensitive_find_haswell_western_europe_alarm_ymm_, //
        haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);
}
 ...
 */
SZ_INTERNAL __m256i sz_utf8_case_insensitive_find_haswell_central_europe_fold_ymm_(__m256i text_ymm) {
    __m256i result_ymm = sz_utf8_case_insensitive_find_haswell_ascii_fold_ymm_(text_ymm);
    __m256i previous_bytes_ymm = sz_utf8_ci_haswell_previous_bytes_(text_ymm);
    __m256i is_after_c3_ymm = _mm256_cmpeq_epi8(previous_bytes_ymm, _mm256_set1_epi8((char)0xC3));
    ...
    __m256i c4_ranges_ymm = _mm256_or_si256(
        _mm256_andnot_si256(is_odd_ymm, sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x80, 0x38)), // C4 80-B7 even
        _mm256_and_si256(is_odd_ymm, sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0xB9, 0x05)));   // C4 B9-BD odd
    __m256i c5_ranges_ymm = _mm256_or_si256(
        _mm256_and_si256(is_odd_ymm, _mm256_or_si256(sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x81, 0x07),   // 81-87
                                                     sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0xB9, 0x05))), // B9-BD
        _mm256_andnot_si256(is_odd_ymm, sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x8A, 0x2D))); // C5 8A-B6 even
 ...
 *  - EF AC 80-86: Latin ligatures 'ﬀ'-'ﬆ' → ASCII pairs/triples
 */
SZ_INTERNAL sz_u32_t sz_utf8_case_insensitive_find_haswell_central_europe_alarm_ymm_(__m256i text_ymm,
                                                                                     sz_u32_t load_mask) {
    sz_unused_(load_mask); // Present for the shared `sz_utf8_case_insensitive_alarm_ymm_t_` signature
 ...
 *  @sa sz_utf8_case_rune_safe_central_europe_k
 */
SZ_INTERNAL sz_cptr_t sz_utf8_case_insensitive_find_haswell_central_europe_( //
    sz_cptr_t haystack, sz_size_t haystack_length,                           //
    sz_cptr_t needle, sz_size_t needle_length,                               //
    sz_utf8_case_insensitive_needle_metadata_t const *needle_metadata,       //
    sz_size_t *matched_length) {
    return sz_utf8_case_insensitive_find_haswell_scripted_( //
        sz_utf8_case_insensitive_find_haswell_central_europe_fold_ymm_,
        sz_utf8_case_insensitive_find_haswell_central_europe_alarm_ymm_, //
        haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);
}
 ...
 */
SZ_INTERNAL __m256i sz_utf8_case_insensitive_find_haswell_cyrillic_fold_ymm_(__m256i text_ymm) {
    __m256i result_ymm = sz_utf8_case_insensitive_find_haswell_ascii_fold_ymm_(text_ymm);
    __m256i previous_bytes_ymm = sz_utf8_ci_haswell_previous_bytes_(text_ymm);
    ...
    __m256i next_bytes_ymm = sz_utf8_ci_haswell_next_bytes_(text_ymm);
    __m256i is_d0_ymm = _mm256_cmpeq_epi8(text_ymm, _mm256_set1_epi8((char)0xD0));
    __m256i needs_d1_ymm = _mm256_and_si256(
        is_d0_ymm, _mm256_or_si256(sz_utf8_ci_haswell_in_byte_range_(next_bytes_ymm, 0x80, 0x10),
                                   sz_utf8_ci_haswell_in_byte_range_(next_bytes_ymm, 0xA0, 0x10)));
 ...
 */
SZ_INTERNAL sz_u32_t sz_utf8_case_insensitive_find_haswell_cyrillic_alarm_ymm_(__m256i text_ymm, sz_u32_t load_mask) {
    sz_unused_(load_mask); // Present for the shared `sz_utf8_case_insensitive_alarm_ymm_t_` signature
    sz_u32_t is_e1_mask = (sz_u32_t)_mm256_movemask_epi8(_mm256_cmpeq_epi8(text_ymm, _mm256_set1_epi8((char)0xE1)));
    ...
    if (danger_mask) {
        sz_u32_t is_folding_third_mask = (sz_u32_t)_mm256_movemask_epi8(
            sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x80, 0x09));
 ...
 *  @sa sz_utf8_case_rune_safe_cyrillic_k
 */
SZ_INTERNAL sz_cptr_t sz_utf8_case_insensitive_find_haswell_cyrillic_( //
    sz_cptr_t haystack, sz_size_t haystack_length,                     //
    sz_cptr_t needle, sz_size_t needle_length,                         //
    sz_utf8_case_insensitive_needle_metadata_t const *needle_metadata, //
    sz_size_t *matched_length) {
    return sz_utf8_case_insensitive_find_haswell_scripted_( //
        sz_utf8_case_insensitive_find_haswell_cyrillic_fold_ymm_,
        sz_utf8_case_insensitive_find_haswell_cyrillic_alarm_ymm_, //
        haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);
}
...
SZ_PUBLIC sz_cptr_t sz_utf8_case_insensitive_find_haswell( //
    ...
    if (needle_metadata->kernel_id == sz_utf8_case_rune_ascii_invariant_k) {
        if (needle_metadata->folded_slice_length <= 3)
            return sz_utf8_case_insensitive_find_haswell_ascii_3probe_( //
                haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);
        else
            return sz_utf8_case_insensitive_find_haswell_ascii_4probe_( //
                haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);
    }

    if (needle_metadata->kernel_id == sz_utf8_case_rune_safe_western_europe_k)
        return sz_utf8_case_insensitive_find_haswell_western_europe_( //
            haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);

    if (needle_metadata->kernel_id == sz_utf8_case_rune_safe_central_europe_k)
        return sz_utf8_case_insensitive_find_haswell_central_europe_( //
            haystack, haystack_length, needle, needle_length, needle_metadata, matched_length);
...
SZ_PUBLIC sz_bool_t sz_utf8_case_invariant_haswell(sz_cptr_t str, sz_size_t length) {
    ...
    while (length) {
        ...
        sz_u32_t lead_mask = sz_utf8_ci_haswell_mask_until_(block_length);
        __m256i text_ymm = length >= 32 ? _mm256_lddqu_si256((__m256i const *)text_cursor)
                                        : sz_utf8_ci_haswell_load_padded_ymm_(text_cursor, length);

        // 1. ASCII letter check (zeros beyond the string are fine - not letters)
        sz_u32_t is_upper_mask = (sz_u32_t)_mm256_movemask_epi8(sz_utf8_ci_haswell_in_byte_range_(text_ymm, 'A', 26));
        sz_u32_t is_lower_mask = (sz_u32_t)_mm256_movemask_epi8(sz_utf8_ci_haswell_in_byte_range_(text_ymm, 'a', 26));
        ...
        if (is_non_ascii_mask) {
            ...
            if (is_two_mask) {
                sz_u32_t is_bicameral_mask = (sz_u32_t)_mm256_movemask_epi8(
                    sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0xC3, 0x14));
            ...
            if (is_three_mask) {
                ...
                if (is_e2_mask) {
                    sz_u32_t e2_second_safe_mask = (sz_u32_t)_mm256_movemask_epi8(
                        sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x80, 0x04));
                ...
                if (is_ea_mask) {
                    sz_u32_t is_99_range_mask = (sz_u32_t)_mm256_movemask_epi8(
                        sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0x99, 0x07));
                    sz_u32_t is_ac_range_mask = (sz_u32_t)_mm256_movemask_epi8(
                        sz_utf8_ci_haswell_in_byte_range_(text_ymm, 0xAC, 0x03));
