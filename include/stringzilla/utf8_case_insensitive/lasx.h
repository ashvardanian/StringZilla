/**
 *  @brief LoongArch LASX case-insensitive UTF-8 search, comparison & invariance backend.
 *  @file include/stringzilla/utf8_case_insensitive/lasx.h
 *  @author Ash Vardanian
 *  @sa include/stringzilla/utf8_case_insensitive.h
 */
#ifndef STRINGZILLA_UTF8_CASE_INSENSITIVE_LASX_H_
#define STRINGZILLA_UTF8_CASE_INSENSITIVE_LASX_H_
...
SZ_PUBLIC sz_cptr_t sz_utf8_case_insensitive_find_lasx( //
...
SZ_PUBLIC sz_bool_t sz_utf8_case_invariant_lasx(sz_cptr_t str, sz_size_t length) {
    return sz_utf8_case_invariant_serial(str, length);
}

SZ_PUBLIC sz_ordering_t sz_utf8_case_insensitive_order_lasx(sz_cptr_t a, sz_size_t a_length, sz_cptr_t b,
                                                            sz_size_t b_length) {
...
#endif // STRINGZILLA_UTF8_CASE_INSENSITIVE_LASX_H_
