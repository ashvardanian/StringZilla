...
SZ_HELPER_AUTO __m256i sz_grapheme_bmp_descriptor_haswell_(__m256i high_bytes_u8x32, __m256i low_bytes_u8x32) {
...
SZ_HELPER_AUTO __m256i sz_grapheme_astral_descriptor_haswell_(__m256i plane_u8x32, __m256i high_u8x32,
                                                              __m256i low_u8x32) {
...
SZ_HELPER_AUTO sz_u64_t sz_grapheme_cp_in_range_haswell_(__m256i high_lo_u8x32, __m256i low_lo_u8x32,
    ...
    __m256i const hi_h_v_u8x32 = _mm256_set1_epi8((char)hi_h), hi_l_v_u8x32 = _mm256_set1_epi8((char)hi_l);
    // ge_low: high>lo_h, or (high==lo_h and low>=lo_l). le_high: high<hi_h, or (high==hi_h and low<=hi_l).
    __m256i const ge_low_lo_u8x32 = _mm256_or_si256(
        _mm256_andnot_si256(_mm256_cmpeq_epi8(high_lo_u8x32, lo_h_v_u8x32),
                            sz_grapheme_cmpge_epu8_haswell_(high_lo_u8x32, lo_h_v_u8x32)),
        _mm256_and_si256(_mm256_cmpeq_epi8(high_lo_u8x32, lo_h_v_u8x32),
                         sz_grapheme_cmpge_epu8_haswell_(low_lo_u8x32, lo_l_v_u8x32)));
    __m256i const ge_low_hi_u8x32 = _mm256_or_si256(
        _mm256_andnot_si256(_mm256_cmpeq_epi8(high_hi_u8x32, lo_h_v_u8x32),
                            sz_grapheme_cmpge_epu8_haswell_(high_hi_u8x32, lo_h_v_u8x32)),
        _mm256_and_si256(_mm256_cmpeq_epi8(high_hi_u8x32, lo_h_v_u8x32),
                         sz_grapheme_cmpge_epu8_haswell_(low_hi_u8x32, lo_l_v_u8x32)));
    __m256i const le_high_lo_u8x32 = _mm256_or_si256(
        _mm256_andnot_si256(_mm256_cmpeq_epi8(high_lo_u8x32, hi_h_v_u8x32),
                            sz_grapheme_cmpge_epu8_haswell_(hi_h_v_u8x32, high_lo_u8x32)),
        _mm256_and_si256(_mm256_cmpeq_epi8(high_lo_u8x32, hi_h_v_u8x32),
                         sz_grapheme_cmpge_epu8_haswell_(hi_l_v_u8x32, low_lo_u8x32)));
    __m256i const le_high_hi_u8x32 = _mm256_or_si256(
        _mm256_andnot_si256(_mm256_cmpeq_epi8(high_hi_u8x32, hi_h_v_u8x32),
                            sz_grapheme_cmpge_epu8_haswell_(hi_h_v_u8x32, high_hi_u8x32)),
        _mm256_and_si256(_mm256_cmpeq_epi8(high_hi_u8x32, hi_h_v_u8x32),
                         sz_grapheme_cmpge_epu8_haswell_(hi_l_v_u8x32, low_hi_u8x32)));
    return sz_utf8_mask_combine_haswell_(_mm256_and_si256(ge_low_lo_u8x32, le_high_lo_u8x32),
...
SZ_HELPER_AUTO sz_u64_t sz_grapheme_cjk_other_haswell_(__m256i high_lo_u8x32, __m256i low_lo_u8x32,
    ...
    sz_u64_t const run_b = sz_grapheme_cp_in_range_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32,
                                                            0xD7FC, 0xFB1D);
    sz_u64_t const exc_a = sz_grapheme_cp_in_range_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32,
                                                            0x302A, 0x3030);
    sz_u64_t const exc_b = sz_grapheme_cp_in_range_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32,
                                                            0x3099, 0x309A);
    sz_u64_t const exc_c = sz_grapheme_cp_in_range_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32,
                                                            0x303D, 0x303D);
    sz_u64_t const exc_d = sz_grapheme_cp_in_range_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32,
                                                            0x3297, 0x3297);
    sz_u64_t const exc_e = sz_grapheme_cp_in_range_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32,
                                                            0x3299, 0x3299);
...
SZ_HELPER_AUTO sz_grapheme_classified_haswell_t sz_grapheme_classify_window_haswell_( //
    ...
    if (loaded < 64) {
        next1_lo_p_u8x32 = _mm256_and_si256(next1_lo_u8x32,
                                            sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(loaded_mask >> 1)));
        next1_hi_p_u8x32 = _mm256_and_si256(next1_hi_u8x32,
                                            sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)((loaded_mask >> 1) >> 32)));
        next2_lo_p_u8x32 = _mm256_and_si256(next2_lo_u8x32,
                                            sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(loaded_mask >> 2)));
        next2_hi_p_u8x32 = _mm256_and_si256(next2_hi_u8x32,
                                            sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)((loaded_mask >> 2) >> 32)));
        next3_lo_p_u8x32 = _mm256_and_si256(next3_lo_u8x32,
                                            sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(loaded_mask >> 3)));
        next3_hi_p_u8x32 = _mm256_and_si256(next3_hi_u8x32,
    ...
    __m256i const two_high_lo_u8x32 = sz_utf8_srl8_haswell_(_mm256_and_si256(raw_lo_u8x32, c1f_u8x32), 2, 0x07);
    __m256i const two_high_hi_u8x32 = sz_utf8_srl8_haswell_(_mm256_and_si256(raw_hi_u8x32, c1f_u8x32), 2, 0x07);
    __m256i const two_low_lo_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(raw_lo_u8x32, c03_u8x32), 6),
                                                     _mm256_and_si256(next1_lo_p_u8x32, c3f_u8x32));
    __m256i const two_low_hi_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(raw_hi_u8x32, c03_u8x32), 6),
                                                     _mm256_and_si256(next1_hi_p_u8x32, c3f_u8x32));
    // 3-byte: high = ((lead & 0x0F) << 4) | ((next1 >> 2) & 0x0F); low = ((next1 & 0x03) << 6) | (next2 & 0x3F).
    __m256i const three_high_lo_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(raw_lo_u8x32, c0f_u8x32), 4),
                                                        sz_utf8_srl8_haswell_(next1_lo_p_u8x32, 2, 0x0F));
    __m256i const three_high_hi_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(raw_hi_u8x32, c0f_u8x32), 4),
                                                        sz_utf8_srl8_haswell_(next1_hi_p_u8x32, 2, 0x0F));
    __m256i const three_low_lo_u8x32 = _mm256_or_si256(
        _mm256_slli_epi16(_mm256_and_si256(next1_lo_p_u8x32, c03_u8x32), 6),
        _mm256_and_si256(next2_lo_p_u8x32, c3f_u8x32));
    __m256i const three_low_hi_u8x32 = _mm256_or_si256(
        _mm256_slli_epi16(_mm256_and_si256(next1_hi_p_u8x32, c03_u8x32), 6),
        _mm256_and_si256(next2_hi_p_u8x32, c3f_u8x32));

    sz_u64_t const ascii = sz_utf8_mask_combine_haswell_(
        _mm256_cmpeq_epi8(_mm256_and_si256(raw_lo_u8x32, _mm256_set1_epi8((char)0x80)), _mm256_setzero_si256()),
        _mm256_cmpeq_epi8(_mm256_and_si256(raw_hi_u8x32, _mm256_set1_epi8((char)0x80)), _mm256_setzero_si256()));
    sz_u64_t const three_byte = decoded.three_byte_starts;
    sz_u64_t const four_byte = decoded.four_byte_starts;

    __m256i const three_sel_lo_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)three_byte);
    __m256i const three_sel_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(three_byte >> 32));
    __m256i const ascii_sel_lo_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)ascii);
    __m256i const ascii_sel_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(ascii >> 32));

    __m256i non_ascii_high_lo_u8x32 = _mm256_blendv_epi8(two_high_lo_u8x32, three_high_lo_u8x32, three_sel_lo_u8x32);
    __m256i non_ascii_high_hi_u8x32 = _mm256_blendv_epi8(two_high_hi_u8x32, three_high_hi_u8x32, three_sel_hi_u8x32);
    __m256i non_ascii_low_lo_u8x32 = _mm256_blendv_epi8(two_low_lo_u8x32, three_low_lo_u8x32, three_sel_lo_u8x32);
    __m256i non_ascii_low_hi_u8x32 = _mm256_blendv_epi8(two_low_hi_u8x32, three_low_hi_u8x32, three_sel_hi_u8x32);
    // high = ascii ? 0 : non_ascii_high; low = ascii ? raw : non_ascii_low.
    __m256i high_lo_u8x32 = _mm256_andnot_si256(ascii_sel_lo_u8x32, non_ascii_high_lo_u8x32);
    __m256i high_hi_u8x32 = _mm256_andnot_si256(ascii_sel_hi_u8x32, non_ascii_high_hi_u8x32);
    __m256i low_lo_u8x32 = _mm256_blendv_epi8(non_ascii_low_lo_u8x32, raw_lo_u8x32, ascii_sel_lo_u8x32);
    __m256i low_hi_u8x32 = _mm256_blendv_epi8(non_ascii_low_hi_u8x32, raw_hi_u8x32, ascii_sel_hi_u8x32);

    // Astral plane/mid/low (offset domain reconstruction): plane = ((b0&7)<<2)|((next1>>4)&3);
    // mid = ((next1&F)<<4)|((next2>>2)&F); lo = ((next2&3)<<6)|(next3&3F).
    __m256i const plane_lo_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(raw_lo_u8x32, c07_u8x32), 2),
                                                   sz_utf8_srl8_haswell_(next1_lo_p_u8x32, 4, 0x03));
    __m256i const plane_hi_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(raw_hi_u8x32, c07_u8x32), 2),
                                                   sz_utf8_srl8_haswell_(next1_hi_p_u8x32, 4, 0x03));
    __m256i const mid_lo_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(next1_lo_p_u8x32, c0f_u8x32), 4),
                                                 sz_utf8_srl8_haswell_(next2_lo_p_u8x32, 2, 0x0F));
    __m256i const mid_hi_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(next1_hi_p_u8x32, c0f_u8x32), 4),
                                                 sz_utf8_srl8_haswell_(next2_hi_p_u8x32, 2, 0x0F));
    __m256i const alo_lo_u8x32 = _mm256_or_si256(_mm256_slli_epi16(_mm256_and_si256(next2_lo_p_u8x32, c03_u8x32), 6),
                                                 _mm256_and_si256(next3_lo_p_u8x32, c3f_u8x32));
    ...
    // gated on a non-zero in-range plane, mirroring icelake's `is_astral`.)
    {
        ...
        __m256i const four_sel_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_(
            (sz_u32_t)(decoded.four_byte_starts >> 32));
        high_lo_u8x32 = _mm256_blendv_epi8(high_lo_u8x32, mid_lo_u8x32, four_sel_lo_u8x32);
        high_hi_u8x32 = _mm256_blendv_epi8(high_hi_u8x32, mid_hi_u8x32, four_sel_hi_u8x32);
        low_lo_u8x32 = _mm256_blendv_epi8(low_lo_u8x32, alo_lo_u8x32, four_sel_lo_u8x32);
        low_hi_u8x32 = _mm256_blendv_epi8(low_hi_u8x32, alo_hi_u8x32, four_sel_hi_u8x32);
    }
    ...
    __m256i desc_lo_u8x32 = ascii_desc_lo_u8x32, desc_hi_u8x32 = ascii_desc_hi_u8x32;
    sz_u64_t cold = non_ascii;
    if (non_ascii) {
        sz_u64_t const cjk_other =
            sz_grapheme_cjk_other_haswell_(high_lo_u8x32, low_lo_u8x32, high_hi_u8x32, low_hi_u8x32) & non_ascii;
        ...
        __m256i const cjk_sel_lo_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)cjk_other);
        __m256i const cjk_sel_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(cjk_other >> 32));
        desc_lo_u8x32 = _mm256_andnot_si256(cjk_sel_lo_u8x32, desc_lo_u8x32);
    ...
    if (cold) {
        ...
        __m256i const ascii_sel2_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(ascii >> 32));
        desc_lo_u8x32 = _mm256_blendv_epi8(bmp_lo_u8x32, ascii_desc_lo_u8x32, ascii_sel2_lo_u8x32);
        desc_hi_u8x32 = _mm256_blendv_epi8(bmp_hi_u8x32, ascii_desc_hi_u8x32, ascii_sel2_hi_u8x32);
    }
    ...
    sz_u64_t const plane_nonzero = sz_utf8_mask_combine_haswell_(
        _mm256_cmpgt_epi8(plane_lo_u8x32, _mm256_setzero_si256()),
        _mm256_cmpgt_epi8(plane_hi_u8x32, _mm256_setzero_si256()));
    sz_u64_t const plane_le_16 = sz_utf8_mask_combine_haswell_(
        sz_grapheme_cmpge_epu8_haswell_(_mm256_set1_epi8(0x10), plane_lo_u8x32),
        sz_grapheme_cmpge_epu8_haswell_(_mm256_set1_epi8(0x10), plane_hi_u8x32));
    ...
    if (is_astral) {
        ...
        __m256i const astral_sel_lo_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)is_astral);
        __m256i const astral_sel_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(is_astral >> 32));
        __m256i const plane_off_lo_u8x32 = _mm256_sub_epi8(_mm256_and_si256(astral_sel_lo_u8x32, plane_lo_u8x32),
                                                           _mm256_set1_epi8(1));
        __m256i const plane_off_hi_u8x32 = _mm256_sub_epi8(_mm256_and_si256(astral_sel_hi_u8x32, plane_hi_u8x32),
                                                           _mm256_set1_epi8(1));
        __m256i const astral_lo_u8x32 = sz_grapheme_astral_descriptor_haswell_(plane_off_lo_u8x32, mid_lo_u8x32,
                                                                               alo_lo_u8x32);
        __m256i const astral_hi_u8x32 = sz_grapheme_astral_descriptor_haswell_(plane_off_hi_u8x32, mid_hi_u8x32,
                                                                               alo_hi_u8x32);
        desc_lo_u8x32 = _mm256_blendv_epi8(desc_lo_u8x32, astral_lo_u8x32, astral_sel_lo_u8x32);
        desc_hi_u8x32 = _mm256_blendv_epi8(desc_hi_u8x32, astral_hi_u8x32, astral_sel_hi_u8x32);
    }
    if (is_overrange) {
        // cp >= 0x110000: clear to Other (0), the BMP-path value seated on these lanes is meaningless.
        desc_lo_u8x32 = _mm256_andnot_si256(sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)is_overrange),
                                            desc_lo_u8x32);
        desc_hi_u8x32 = _mm256_andnot_si256(sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(is_overrange >> 32)),
                                            desc_hi_u8x32);
    }

    // `0xF8..0xFF` begin no valid sequence and match no lead-length mask; force their start lanes to the Other
    // descriptor (0) so they classify neighbour-independently, matching serial/icelake (U+FFFD → Other).
    sz_u64_t const invalid_lead = sz_utf8_mask_combine_haswell_(
        _mm256_cmpeq_epi8(_mm256_max_epu8(raw_lo_u8x32, _mm256_set1_epi8((char)0xF8)), raw_lo_u8x32),
        _mm256_cmpeq_epi8(_mm256_max_epu8(raw_hi_u8x32, _mm256_set1_epi8((char)0xF8)), raw_hi_u8x32));
    __m256i const valid_sel_lo_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)~invalid_lead);
    __m256i const valid_sel_hi_u8x32 = sz_utf8_byte_mask_from_bits_haswell_((sz_u32_t)(~invalid_lead >> 32));
    desc_lo_u8x32 = _mm256_and_si256(desc_lo_u8x32, valid_sel_lo_u8x32);
...
SZ_HELPER_INLINE sz_grapheme_window_masks_t sz_grapheme_build_masks_haswell_(
    ...
    for (int class_index = 0; class_index < 14; ++class_index) {
        __m256i const class_value_u8x32 = _mm256_set1_epi8((char)class_index);
        sz_u64_t const byte_mask = sz_utf8_mask_combine_haswell_(_mm256_cmpeq_epi8(class_lo_u8x32, class_value_u8x32),
                                                                 _mm256_cmpeq_epi8(class_hi_u8x32, class_value_u8x32));
        masks.class_bit[class_index] = _pext_u64(byte_mask, starts) & valid;
    }
    __m256i const ext_bit_u8x32 = _mm256_set1_epi8(0x40);
    sz_u64_t const ext_byte = sz_utf8_mask_combine_haswell_(
        _mm256_cmpeq_epi8(_mm256_and_si256(desc_lo_u8x32, ext_bit_u8x32), ext_bit_u8x32),
        _mm256_cmpeq_epi8(_mm256_and_si256(desc_hi_u8x32, ext_bit_u8x32), ext_bit_u8x32));
    masks.extended_pictographic = _pext_u64(ext_byte, starts) & valid;
    __m256i const incb_lo_u8x32 = _mm256_and_si256(sz_utf8_srl8_haswell_(desc_lo_u8x32, 4, 0x0F),
                                                   _mm256_set1_epi8(0x03));
    __m256i const incb_hi_u8x32 = _mm256_and_si256(sz_utf8_srl8_haswell_(desc_hi_u8x32, 4, 0x0F),
                                                   _mm256_set1_epi8(0x03));
    __m256i const incb_consonant_u8x32 = _mm256_set1_epi8((char)sz_grapheme_incb_consonant_k);
    __m256i const incb_extend_u8x32 = _mm256_set1_epi8((char)sz_grapheme_incb_extend_k);
    __m256i const incb_linker_u8x32 = _mm256_set1_epi8((char)sz_grapheme_incb_linker_k);
    masks.indic_consonant = _pext_u64(
                                sz_utf8_mask_combine_haswell_(_mm256_cmpeq_epi8(incb_lo_u8x32, incb_consonant_u8x32),
                                                              _mm256_cmpeq_epi8(incb_hi_u8x32, incb_consonant_u8x32)),
                                starts) &
                            valid;
    masks.indic_extend = _pext_u64(sz_utf8_mask_combine_haswell_(_mm256_cmpeq_epi8(incb_lo_u8x32, incb_extend_u8x32),
                                                                 _mm256_cmpeq_epi8(incb_hi_u8x32, incb_extend_u8x32)),
                                   starts) &
                         valid;
    masks.indic_linker = _pext_u64(sz_utf8_mask_combine_haswell_(_mm256_cmpeq_epi8(incb_lo_u8x32, incb_linker_u8x32),
                                                                 _mm256_cmpeq_epi8(incb_hi_u8x32, incb_linker_u8x32)),
                                   starts) &
                         valid;
    return masks;
}
